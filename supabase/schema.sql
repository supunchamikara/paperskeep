...
-- ============================================================
-- EV charging stations — powers the public /ev-map page.
-- Seeded from sri_lanka_ev_charging_stations.csv (see
-- `npm run db:seed:ev`). Read-only for the public key; every
-- write goes through the service-role seed script.
-- ============================================================
