...
export default function EvMap({ stations }: { stations: EvStation[] }) {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="pointer-events-none absolute right-3 top-3 z-[1100] rounded-pill bg-surface/95 px-3.5 py-1.5 font-heading text-[12.5px] font-semibold text-text shadow-token">
        {located.length
      ...
      <aside
        ...
        className={`absolute z-[1200] bg-surface shadow-lift transition-transform duration-300 ease-out
          inset-x-0 bottom-0 max-h-[68%] rounded-t-block border-t border-border
          md:inset-y-0 md:right-auto md:left-0 md:w-[360px] md:max-h-none md:rounded-none md:border-r md:border-t-0
          ${
            selected
      ...
      >
        {selected && (
          <div className="flex h-full max-h-[68vh] flex-col md:max-h-none">
