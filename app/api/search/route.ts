...
const staticEntries = [
  ...
  {
    slug: "tools-cover-designer",
    href: "/tools/cover-designer",
    title: "Cover Designer — Free Online Book Cover Maker",
    excerpt:
      "Upload an image, add your title and author in professional cover typography, and export a Kindle, print or audiobook cover as a PNG or JPG.",
    category: "Tool",
    tags: [
      "cover designer",
      "book cover",
