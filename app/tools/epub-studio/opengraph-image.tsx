...
export const alt = "EPUB Studio — KDP-optimized EPUB creator";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

/** Share card for /tools/epub-studio. */
export default function EpubStudioOgImage() {
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "30px", color: "#93A2B7", maxWidth: "960px" }}>
            Write, style and export a KDP-ready EPUB — entirely in your browser
          </div>
        </div>
